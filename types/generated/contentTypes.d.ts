...
export interface ApiContactContact extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    contactEmail: Schema.Attribute.Text;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    email: Schema.Attribute.Text;
    ...
    > &
      Schema.Attribute.Private;
    message: Schema.Attribute.Text;
    messageSuccess: Schema.Attribute.Text;
    name: Schema.Attribute.Text;
    phone: Schema.Attribute.Text;
    publishedAt: Schema.Attribute.DateTime;
    sendMessage: Schema.Attribute.Text;
    sendMessageBtn: Schema.Attribute.Text;
    subject: Schema.Attribute.Text;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    validateForm: Schema.Attribute.Text;
  };
}
...
export interface ApiDashboardDashboard extends Struct.SingleTypeSchema {
  ...
  attributes: {
    AiText: Schema.Attribute.Text;
    analyseBtn: Schema.Attribute.Text;
    chatGptBtn: Schema.Attribute.Text;
    checkForAIBtn: Schema.Attribute.Text;
    claudeBtn: Schema.Attribute.Text;
    clearBtn: Schema.Attribute.Text;
    contentAtScaleText: Schema.Attribute.Text;
    copyLeaksText: Schema.Attribute.Text;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    crossPlagText: Schema.Attribute.Text;
    detectionInfoText: Schema.Attribute.Text;
    detectorBtn: Schema.Attribute.Text;
    detectorHeadingText: Schema.Attribute.Text;
    detectorInputPlaceholder: Schema.Attribute.Text;
    detectorSubtileText: Schema.Attribute.Text;
    ...
    > &
      Schema.Attribute.Private;
    openAIText: Schema.Attribute.Text;
    pasteText: Schema.Attribute.Text;
    publishedAt: Schema.Attribute.DateTime;
    recentDetectionsBtn: Schema.Attribute.Text;
    recentDetectionsText: Schema.Attribute.Text;
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    viewRecentDetectionsBtn: Schema.Attribute.Text;
    viewRecentDetectionsText: Schema.Attribute.Text;
    writerText: Schema.Attribute.Text;
    zeroGptText: Schema.Attribute.Text;
  };
}

export interface ApiForgotPasswordForgotPassword
  ...
  attributes: {
    anotherLinkBtn: Schema.Attribute.Text;
    backToLoginText: Schema.Attribute.Text;
    checkEmailText: Schema.Attribute.Text;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    emailPlaceholder: Schema.Attribute.Text;
    emailRequiredText: Schema.Attribute.Text;
    faildToSend: Schema.Attribute.String;
    followInstructionsFirstText: Schema.Attribute.Text;
    followInstructionsSecondText: Schema.Attribute.Text;
    linkSentText: Schema.Attribute.Text;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
    ...
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    resetInstructionsText: Schema.Attribute.Text;
    sendBtn: Schema.Attribute.Text;
    sendLoadingBtn: Schema.Attribute.Text;
    title: Schema.Attribute.Text;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    vaildEmail: Schema.Attribute.Text;
  };
}
...
export interface ApiHeaderHeader extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    logoutBtn: Schema.Attribute.Text;
    logoutLoadingBtn: Schema.Attribute.Text;
    publishedAt: Schema.Attribute.DateTime;
    recentDetectionsBtn: Schema.Attribute.Text;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
...
export interface ApiLandingPageFooterLandingPageFooter
  extends Struct.SingleTypeSchema {
  collectionName: 'landing_page_footers';
  info: {
    displayName: 'Landing Page Footer';
    pluralName: 'landing-page-footers';
    singularName: 'landing-page-footer';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::landing-page-footer.landing-page-footer'
    > &
      Schema.Attribute.Private;
...
export interface ApiLandingPageLandingPage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    detailedReportsHeading: Schema.Attribute.Text;
    detailedReportsSubHeading: Schema.Attribute.Text;
    fastProcessingHeading: Schema.Attribute.Text;
    fastProcessingSubHeading: Schema.Attribute.Text;
    footerHeading: Schema.Attribute.Text;
    getStartedBtn: Schema.Attribute.Text;
    heading: Schema.Attribute.Text;
    highAccuracyHeading: Schema.Attribute.Text;
    highAccuracySubHeading: Schema.Attribute.Text;
    keyFeaturesText: Schema.Attribute.Text;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
    ...
    > &
      Schema.Attribute.Private;
    loginBtn: Schema.Attribute.Text;
    privacyText: Schema.Attribute.Text;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiLoginLogin extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    emailPlaceholder: Schema.Attribute.Text;
    emailRequiredText: Schema.Attribute.Text;
    forgotPasswordText: Schema.Attribute.Text;
    invalidCredentialsText: Schema.Attribute.Text;
    locale: Schema.Attribute.String;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::login.login'>;
    noAccountText: Schema.Attribute.Text;
...
export interface ApiRecentDetectionRecentDetection
  extends Struct.SingleTypeSchema {
  collectionName: 'recent_detections';
  info: {
    description: '';
    displayName: 'Recent Detection';
    pluralName: 'recent-detections';
    singularName: 'recent-detection';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::recent-detection.recent-detection'
    > &
      Schema.Attribute.Private;
    ...
    tableCopiedText: Schema.Attribute.Text;
    tableDate: Schema.Attribute.Text;
    tableDeleteBtn: Schema.Attribute.Text;
    tableDeleteDetection: Schema.Attribute.Text;
    tableDeleteDetectionSub: Schema.Attribute.Text;
    tableDeleteDetectionSuccess: Schema.Attribute.Text;
    ...
    tablePreviousBtn: Schema.Attribute.Text;
    tableResult: Schema.Attribute.Text;
    tableSearch: Schema.Attribute.Text;
    tableText: Schema.Attribute.Text;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiSignUpSignUp extends Struct.SingleTypeSchema {
  ...
  attributes: {
    alreadyHaveText: Schema.Attribute.Text;
    confirmPasswordPlaceholder: Schema.Attribute.Text;
    confirmPasswordPlaceholderError: Schema.Attribute.Text;
    confirmPasswordText: Schema.Attribute.Text;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    emailExistText: Schema.Attribute.Text;
    emailPlaceholder: Schema.Attribute.Text;
    emailRequiredText: Schema.Attribute.Text;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::landing-page-footer.landing-page-footer': ApiLandingPageFooterLandingPageFooter;
